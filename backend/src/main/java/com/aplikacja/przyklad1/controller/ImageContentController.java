...
@CrossOrigin(origins = "http://13.93.205.222:8081:8081")
@RestController
...
public class ImageContentController {
    ...
    // Aktualizacja treści
    @PutMapping("/{id}")
    public ResponseEntity<ImageContent> updateContent(@PathVariable String id,
            @RequestBody ImageContent contentDetails) {
